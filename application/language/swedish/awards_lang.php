...
$lang['awards_pota_description_ln2'] = "Parks on the Air® (POTA) är ett världsomspännande amatörradioprogram som uppmuntrar portabelkörning från officiellt utpekade parker och skyddade områden.";
$lang['awards_pota_description_ln3'] = "Operatörer som aktiverar parker kallas Activators, medan stationer som kontaktar dem kallas Hunters. POTA erbjuder utmärkelser och prestationer för aktiveringar, jakt, park-till-park-kontakter och aktivitet över parker, band och trafiksätt.";
$lang['awards_pota_description_ln4'] = "För mer information om programmet, utmärkelserna och reglerna, besök <a href='https://docs.pota.app/docs/awards.html' target='_blank'>POTA-dokumentationen</a> eller <a href='https://pota.app/' target='_blank'>Parks on the Air®-webbplatsen</a>.";

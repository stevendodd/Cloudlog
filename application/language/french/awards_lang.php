...
$lang['awards_pota_description_ln2'] = "Parks on the Air® (POTA) est un programme radioamateur mondial qui encourage l'activité portable depuis des parcs et zones protégées officiellement désignés.";
$lang['awards_pota_description_ln3'] = "Les opérateurs qui activent des parcs sont appelés Activators, tandis que les stations qui les contactent sont des Hunters. POTA propose des récompenses et distinctions pour les activations, la chasse, les contacts park-to-park et l'activité sur différents parcs, bandes et modes.";
$lang['awards_pota_description_ln4'] = "Pour plus d'informations sur le programme, les récompenses et les règles, consultez la <a href='https://docs.pota.app/docs/awards.html' target='_blank'>documentation POTA</a> ou le <a href='https://pota.app/' target='_blank'>site Parks on the Air®</a>.";

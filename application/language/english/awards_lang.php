...
$lang['awards_pota_description_ln2'] = "Parks on the Air® (POTA) is a worldwide amateur radio program that encourages portable operation from officially designated parks and protected areas.";
$lang['awards_pota_description_ln3'] = "Operators activating parks are known as Activators, while stations contacting them are Hunters. POTA offers awards and achievements for activations, hunts, park-to-park contacts, and activity across parks, bands, and modes.";
$lang['awards_pota_description_ln4'] = "For more information about the program, awards, and rules, please visit the <a href='https://docs.pota.app/docs/awards.html' target='_blank'>POTA documentation</a> or the <a href='https://pota.app/' target='_blank'>Parks on the Air® website</a>.";
